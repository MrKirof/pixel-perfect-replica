...
const projects = [
  ...
  },
  {
    ...
    filter: "Print",
    desc: "Eye-catching book cover design with bold visual storytelling and compelling typography.",
  ...
  },
  {
    ...
    filter: "Social Media",
    desc: "Engaging social media content design with scroll-stopping visuals and brand consistency.",
  ...
  },
  {
    ...
    category: "Brand Identity",
    filter: "Branding",
    desc: "Bold vehicle wrap design for an SUV — high-impact mobile branding.",
